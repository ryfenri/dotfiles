...
class SuspendButton(PowermenuButton):
    def __init__(self):
        super().__init__(
            label="Suspend", icon_name="night-light-symbolic", on_click=self._invoke
        )
        ...
        super().__init__(
            ...
            child=widgets.Overlay(
                child=widgets.Button(
                    ...
                    on_click=lambda x: window_manager.close_window("rybelika_POWERMENU"),
                ),
                overlays=[main_box],
            ),
            css_classes=["unset"],
